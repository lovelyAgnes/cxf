 ...
 * 
 */
@WebServiceClient(name = "WebServiceImplService", targetNamespace = "http://webserviceServer/", wsdlLocation = "http://172.26.5.150:8022/WS_Server/Webservice?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEBSERVICEIMPLSERVICE_QNAME = new QName("http://webserviceServer/", "WebServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://172.26.5.150:8022/WS_Server/Webservice?wsdl");
    ...
    public WebServiceImpl getWebServiceImplPort() {
        return super.getPort(new QName("http://webserviceServer/", "WebServiceImplPort"), WebServiceImpl.class);
    }
    ...
    public WebServiceImpl getWebServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webserviceServer/", "WebServiceImplPort"), WebServiceImpl.class, features);
    }
