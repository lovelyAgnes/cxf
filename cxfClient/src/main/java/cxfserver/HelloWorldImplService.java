 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://cxfServer/", wsdlLocation = "http://localhost:8088/cxfServer/cxf/helloworld?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDIMPLSERVICE_QNAME = new QName("http://cxfServer/", "HelloWorldImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8088/cxfServer/cxf/helloworld?wsdl");
    ...
    public HelloWorld getHelloWorldImplPort() {
        return super.getPort(new QName("http://cxfServer/", "HelloWorldImplPort"), HelloWorld.class);
    }
    ...
    public HelloWorld getHelloWorldImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://cxfServer/", "HelloWorldImplPort"), HelloWorld.class, features);
    }
